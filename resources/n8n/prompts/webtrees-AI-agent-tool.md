...
+ MCP inline upload accepts at most 512 KiB decoded. Use authenticated multipart REST for larger files or client payload limits, with an appropriate api_write token. Do not print tokens or image payloads in chat.
